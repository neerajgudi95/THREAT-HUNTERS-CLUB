...
const Possibilities = () => {
  return (
    <motion.div
      ...
      className="thc__possibility section__padding thc__landingPage"
      initial="hidden"
      whileInView="show"
    ...
    >
      ...
      >
        <picture>
          <source
            srcSet="https://ik.imagekit.io/fq9vykvp2/BGIMAGES/emp-removebg.webp?ik-sdk-version=javascript-1.4.3&updatedAt=1677700039756"
            type="image/webp"
            alt="possibility"
          />
